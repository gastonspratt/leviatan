        ...
        lista.forEach(item => {
            ...
            <article class="card">
                ...
                <div class="card-body">
                    ...
                    ${renderizarPrecio(item)}
                    ${esComic && esComicOVNI(item) && parsearPrecio(item.Precio) === null ? `<span data-precio-ovni-key="${escapeAttribute(clave)}">Consultando precio...</span>` : ""}
                    <a
                        class="btn-whatsapp"
                        data-whatsapp-key="${escapeAttribute(clave)}"
